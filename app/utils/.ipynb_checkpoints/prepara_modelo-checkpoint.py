...
def prepara_modelo(nbre_dir_modelo, carrera):
    ...
    # # Construir la ruta al archivo deseado
    # ruta_completa = os.path.join(directorio_script, '../datos/topic_docs.csv')
    
    # # Para normalizar la ruta (eliminar '../')
    # ruta_normalizada = os.path.normpath(ruta_completa)
    
    # try:
    #     with open(ruta_normalizada, 'r') as archivo:
    #         contenido = archivo.read()
    #         print(contenido)
    # except FileNotFoundError:
    #     print("El archivo no fue encontrado.")
    
    # # Intentos de import (manejamos errores amigablemente)
    # try:
    #     from bertopic import BERTopic
    # except Exception as e:
    #     raise ImportError("No se pudo importar BERTopic. Asegurate de ejecutar esto en el entorno donde está instalado (pip show BERTopic).") from e
    
    # try:
    #     from umap import UMAP
    # except Exception as e:
    #     raise ImportError("No se pudo importar umap-learn. Instálalo con `pip install umap-learn`.") from e
    ...
    # ---------------------------
    # RUTAS - ajustá si es necesario
    # ---------------------------
    # Si extrajiste el ZIP a: /mnt/data/model_psico/model_Licenciatura_en_Psicología
    MODEL_FOLDER = os.path.join(path_modelos , nbre_dir_modelo ) #"../modelos/model_Licenciatura_en_Psicología"  # <- carpeta del modelo
    print(MODEL_FOLDER)
    ...
    print("¡Listo! Ahora podés usar /mnt/data/topics_enriquecidos.csv en tu Streamlit para graficar UMAP y mostrar información de cada tópico.")
